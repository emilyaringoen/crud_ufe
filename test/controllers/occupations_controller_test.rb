...
class OccupationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occupation" do
    assert_difference('Occupation.count') do
      post occupations_url, params: { occupation: { salary: @occupation.salary, title: @occupation.title } }
    end
  ...
  test "should update occupation" do
    patch occupation_url(@occupation), params: { occupation: { salary: @occupation.salary, title: @occupation.title } }
